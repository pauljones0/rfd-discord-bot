...
*   **Discord Bot Notifications:** Sends detailed notifications to multiple subscribed Discord servers, complete with relative timestamps, author links, actual deal URLs, and categorized emojis for improved visual clarity (e.g. 💻, 🛒, 🍔).
