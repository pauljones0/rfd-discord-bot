...
*   **Deep Scraping:** Extracts detailed deal content from individual deal pages, including descriptions, comments, and **categories** (which RFD recently moved to detail pages) for better AI context and filtering.
...
*   **Discord Bot Notifications:** Sends detailed notifications to multiple subscribed Discord servers, complete with native Discord timestamps, actual deal URLs, concise engagement metrics, and categorized emojis for improved visual clarity. Now includes the **Retailer/Store name** directly in the footer for instant context.
