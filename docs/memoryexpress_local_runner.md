...
$env:GEMINI_API_KEY="..."
$env:DATABASE_URL="postgres://rfd_bot:...@localhost:5432/rfd_discord_bot?sslmode=disable"
...
If this runner is revived for production, document the storage connection and
