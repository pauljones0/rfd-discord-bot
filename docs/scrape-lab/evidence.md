...
- eBay coupon pages: keep Browse API as source of truth. Page coupon discovery remains post-drop-only, but Stormtrooper still needs a stronger fallback than HTTP/chromedp/nodriver before store-level coupons are reliable there.
