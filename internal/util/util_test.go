...
func TestCleanReferralLink(t *testing.T) {
	bestBuyPrefix := "https://bestbuyca.o93x.net/c/111/222/333?u="
	tests := []struct {
		name     string
		input    string
		expected string
		...
		},
		{
			...
			expected: "https://amazon.ca/dp/12345?tag=example-20",
			changed:  true,
		},
		{
			name:     "Amazon add tag",
		...
		},
		{
			...
			expected: "https://bestbuyca.o93x.net/c/111/222/333?u=https%3A%2F%2Fbestbuy.ca%2Fproduct",
			changed:  true,
		},
		{
		...
		},
		{
			...
			expected: "https://bestbuyca.o93x.net/c/111/222/333?u=https%3A%2F%2Fbestbuy.ca%2Fen-ca%2Fproduct%2F12345",
			changed:  true,
		},
		{
		...
		{
			name:     "eBay US direct link removes tracking params",
		...
		{
			name:     "eBay CA direct link removes tracking params",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, changed := CleanReferralLink(tt.input, "example-20", bestBuyPrefix)
			if got != tt.expected {
